"""Lab 5 command handlers — agent (tool calling), conversational chat
mode, and direct invocations of each registered tool. Lab 1-4 commands
...
HELP_TEXT = (
    "NLP Bot — Lab 1 + Lab 2 + Lab 3 + Lab 4 + Lab 5\n\n"
